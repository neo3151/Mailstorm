...
OUTPUT_FILE = r"C:\Users\neo31\Mailstorm\releases\Mailstorm_Season_1_Finale_Abyssal_Edition.pdf"
...
COVER = get_latest(ARCHIVE_LOCAL, "ep10_cover_hazard_orange")
STORY_PANELS = [
    get_latest(ARCHIVE_LOCAL, "ep10_01_the_avatar"),
    get_latest(ARCHIVE_LOCAL, "ep10_02_four_guilds_assemble"),
    get_latest(ARCHIVE_LOCAL, "ep10_03_the_invocation"),
    get_latest(ARCHIVE_LOCAL, "ep10_04_the_solidarity_mandate"),
    get_latest(ARCHIVE_LOCAL, "ep10_05_the_aftermath"),
]

DOSSIER_CONTRACT = get_latest(ARCHIVE_LOCAL, "ep10_dossier_master_contract")
...
CAPTIONS = {
    0:  ("TL", "THE ALGORITHM DESCENDS. INFINITE METRICS. ZERO EMPATHY."),
    1:  ("BR", "THE TRIBES OF THE ZIGGURAT STAND TOGETHER."),
    2:  ("TL", "KIP INVOKES THE MASTER CONTRACT."),
    3:  ("BR", "THE SOLIDARITY MANDATE SHATTERS THE CORE."),
    4:  ("TL", "THE UNION BREAKS THE MACHINE. BUT THE STORM CONTINUES."),
}
...
def assemble():
    ...
    pdf.set_title("Mailstorm: Episode 10 - The Solidarity Mandate (Season 1 Finale)")
    ...
    print("--- ASSEMBLING SEASON 1 FINALE ABYSSAL EDITION ---")
    add_img(pdf, COVER); prog("Cover Image")
    black_page(pdf, "FORTY YEARS OF DIVISION ERASED."); prog("Inside Front")
    ...
    black_page(pdf, "SEASON TWO CONTINUES THE STORM."); prog("Epilogue Blank")
    
    add_img(pdf, DOSSIER_CONTRACT); prog("Dossier: Master Contract")
